...
},
{
  ...
  author: 'Liu, Ken',
  desc:'A publishing event: Bestselling author Ken Liu selects his award-winning science fiction and fantasy tales for a groundbreaking collection—including a brand-new piece exclusive to this volume. A must-have for every science fiction and fantasy fan, this beautiful book is an anthology to savor.',
  category: 'nonfiction',
  language: 'English',
...
},
{
  ...
  desc:'Drawing on the latest research in neuroscience and psychology, Cordelia Fine debunks the myth of hardwired differences between men’s and women’s brains, unraveling the evidence behind such claims as men’s brains aren’t wired for empathy, and women’s brains aren’t made to fix cars. She then goes one step further, offering a very different explanation of the dissimilarities between men’s and women’s behavior. Instead of a “male brain” and a “female brain,” Fine gives us a glimpse of plastic, mutable minds that are continuously influenced by cultural assumptions about gender.',
  category: 'nonfiction',
  language: 'English',
...
},
{
  ...
  desc:'À la fois émouvante réflexion sur l\'identité et fine satire de nos mœurs locales, ces nouvelles sont écrites avec une efficacité redoutable. Si parfois vous doutez que Montréal ait une âme, la lecture des Aurores montréales vous rassurera.',
  category: 'fiction',
  language: 'French',
...
},
{
  ...
  title: 'Ru',
  author: 'Thúy, Kim',
  desc:'Une femme voyage à travers le désordre des souvenirs : l\'enfance dans sa cage d\'or à Saigon, l\'arrivée du communisme dans le Sud-Vietnam apeuré, la fuite dans le ventre d\'un bateau au large du golfe de Siam, l\'internement dans un camp de réfugiés en Malaisie, les premiers frissons dans le froid du Québec. Récit entre la guerre et la paix, ru dit le vide et le trop-plein, l\'égarement et la beauté. De ce tumulte, des incidents tragi-comiques, des objets ordinaires émergent comme autant de repères d\'un parcours. En évoquant un bracelet en acrylique rempli de diamants, des bols bleus cerclés d\'argent ou la puissance d\'une odeur d\'assouplissant, Kim Thúy restitue le Vietnam d\'hier et d\'aujourd\'hui avec la maîtrise d\'un grand écrivain.',
  category: 'fiction',
  language: 'French',
